...
namespace ShoppingPeeker.DbManage.Utilities
{
    ...
    /// mysql  sql语句占位符操作
    /// </summary>
    internal class SqlStatementTokenizer
    {
        private string sql;
        ...
        public SqlStatementTokenizer(string input)
          : this()
        {
            sql = input;
        }
        ...
        public List<string> GetAllParamedTokens()
        {
            List<string> tokens = new List<string>();
