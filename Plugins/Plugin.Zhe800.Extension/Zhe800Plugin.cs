...
namespace Plugin.Zhe800.Extension
{
    public class Zhe800Plugin : PluginBase<Zhe800Plugin> 
    {
        ...
        public override Dictionary<string, object> ResolveSearchPageContent(string content)
        {
            ...
            var lstTags = new List<KeyWordTag> {
                new KeyWordTag {
                    Platform = NTCPMessage.EntityPackage.SupportPlatformEnum.Zhe800,
            ...
            {
                new Zhe800Product { ItemId=1,Title="测试大衣"}
            };
